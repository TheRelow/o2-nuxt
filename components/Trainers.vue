<template>
  <div class="trainers">
    <div class="trainers__overlay"></div>
    <svg class="trainers__bg" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 1920 200" fill="none">
      <path d="M1920 0L0 200V0H1920Z" fill="#fff"/>
    </svg>
